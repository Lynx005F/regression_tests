...
void redmule_cfg (volatile uint32_t x_address, volatile uint32_t w_address, volatile uint32_t y_address, volatile uint32_t z_address, volatile uint16_t m_size, volatile uint16_t n_size, volatile uint16_t k_size, volatile uint8_t gemm_ops){
